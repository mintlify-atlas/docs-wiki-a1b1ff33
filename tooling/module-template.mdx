...
These are the projects that get published to NuGet and consumed by host applications. The following projects are present in `templates/module/aspnet-core/src/`:
