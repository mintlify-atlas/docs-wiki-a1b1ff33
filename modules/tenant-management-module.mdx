...
The interface also contains two `[Obsolete]` synchronous methods (`FindByName` and `FindById`) retained for backwards compatibility — prefer the async overloads in new code.
